...
All nodes between the starting node and the ending node have values less than or equal to the starting node (i.e.
 ...
 */
public class Humber_of_Good_paths {

    public static void main(String[] args) {

        int[] vals1 = {1, 3, 2, 1, 3};
        int[][] edges1 = {{0, 1}, {0, 2}, {2, 3}, {2, 4}};
        var paths = numberOfGoodPaths(vals1, edges1);
        System.out.printf("Example 1: good paths > %s \n", paths);


        int[] vals2 = {1,1,2,2,3};
        int[][] edges2 = {{0, 1}, {1, 2}, {2, 3}, {2, 4}};
        var paths2 = numberOfGoodPaths(vals2, edges2);
        System.out.printf("Example 1: good paths > %s \n", paths2);


        int[] vals3 = {1};
        int[][] edges3 = {};
        var paths3 = numberOfGoodPaths(vals3, edges3);
        System.out.printf("Example 1: good paths > %s \n", paths3);
    ...
    /**
     * OFFICIAL SOLUTION: https://leetcode.com/problems/number-of-good-paths/solutions/2892908/number-of-good-paths/
     *
     * @param vals
     * @param edges
     *
